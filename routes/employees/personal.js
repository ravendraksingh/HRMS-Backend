...
router.get("/:empid/personal", 
  ...
  try {
    ...
    if (!employee) {
      logger.warn({ route: '/employees/:empid/personal', method: 'GET', empid, requestedBy }, 'Employee not found');
    ...
    if (!personalDetails) {
      logger.warn({ route: '/employees/:empid/personal', method: 'GET', empid, requestedBy }, 'Personal details not found');
...
router.put("/:empid/personal",
  ...
  try {
    ...
    if (!employee) {
      logger.warn({ route: '/employees/:empid/personal', method: 'PUT', empid, requestedBy }, 'Employee not found');
      throw new ApiError("Employee not found", 404);
    }
